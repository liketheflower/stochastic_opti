...
def get_d_j(x_):
    ...
    return d_j*(-2*math.cos(x_)*math.sin(x_))
...
if __name__=='__main__':
   ...
   # print 'res',min[math.cos(_) for _ in estimated_theta]
    plot_new(list(range(len(res))),res,"Resuls of the spherical coordinates parameterization",'exp_est_sphe.eps',r'$n$',r'$\theta_n$')
    #plt.show()
